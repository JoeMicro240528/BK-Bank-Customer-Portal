...
export const landingCopy: Record<Language, LandingCopy> = {
  ...
  ar: {
    ...
    english: "English",
    arabic: "العربية",
    heroTitle: "حدّث بياناتك لدى بنك أمدرمان الوطني",
    heroLogoAlt: "بنك أمدرمان الوطني",
    heroSubtitle:
      "منصة آمنة تتيح لك تحديث بياناتك الشخصية والمالية لدى بنك أمدرمان الوطني بخطوات بسيطة وسهلة.",
    ...
    featureBankDesc: "تحديث بياناتك مباشرة لدى بنك أمدرمان الوطني",
    welcomeGreeting: "مرحباً بك",
    welcomeIntro: "للبدء في تحديث بياناتك لدى بنك أمدرمان الوطني يرجى تسجيل الدخول عبر سوداباس",
    ...
    step4Desc: "أرسل طلبك وتابع حالة المراجعة لدى بنك أمدرمان الوطني",
