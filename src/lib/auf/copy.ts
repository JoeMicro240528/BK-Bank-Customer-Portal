...
export const copy = {
  en: {
    ...
    incomeProofDocType: "Document type",
    incomeProofDocTypeOther: "Specify document type",
    incomeProofDocTypeRequired: "Please select the income proof document type",
    ...
    expectedTxnRequired: "At least one expected financial transaction type must be selected",
  ...
  ar: {
    ...
    incomeProofDocType: "نوع المستند",
    incomeProofDocTypeOther: "نوع المستند الآخر",
    incomeProofDocTypeRequired: "يرجى اختيار نوع المستند",
    workType: "نوع العمل",
    ...
    expectedTxnRequired: "يجب اختيار نوع واحد على الأقل من المعاملات المالية المتوقعة",
